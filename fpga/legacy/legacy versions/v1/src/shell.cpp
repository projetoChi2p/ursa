...
/********** PARAMS VALIDATION ***********************************************************************/
    /*
    // The number of rows of A[a0_p][m] and columns of B[m][b0_q] must be greater than SA_SIZE
    if(a0_p<SA_SIZE || b0_q<SA_SIZE){
        //printf("[sa_shell] Error: The number of rows of A and columns of B must be greater than SA_SIZE\n");
        return SA_BAD_SIZES;
    }
    // The rows of A and columns of B must be multiples of SA_SIZE
    if(a0_p%SA_SIZE!=0 || b0_q%SA_SIZE!=0){
        //printf("[sa_shell] Error: The number of rows of A and columns of B must be multiples of SA_SIZE\n");
        return SA_BAD_SIZES;
    }
    // The total dimensions cannot be larger than type_short
    if(a0_p*b0_q>USHRT_MAX || a0_p*m>USHRT_MAX || b0_q*m>USHRT_MAX ){
        //printf("[sa_shell] Error: The total dimensions cannot be larger than type_short\n");
        return SA_BAD_SIZES;
    }
    */
/********** NORMAL WORKING  *************************************************************************/
