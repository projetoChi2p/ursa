...
architecture behav of mxm_execute_ursa is 
    ...
    "mxm_execute_ursa_mxm_execute_ursa,hls_ip_2023_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020-clg484-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=7.300000,HLS_SYN_LAT=-1,HLS_SYN_TPT=-1,HLS_SYN_MEM=8,HLS_SYN_DSP=0,HLS_SYN_FF=8872,HLS_SYN_LUT=10664,HLS_VERSION=2023_2}";
    ...
    component mxm_execute_ursa_Block_entry61_proc IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
    ...
    component mxm_execute_ursa_fifo_w13_d2_S IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
...
begin
    ...
    Block_entry61_proc_U0 : component mxm_execute_ursa_Block_entry61_proc
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
    ...
    call_a_cast_loc_channel_U : component mxm_execute_ursa_fifo_w13_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
    ...
    call_b_cast_loc_channel_U : component mxm_execute_ursa_fifo_w13_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    m_cast10_loc_channel_U : component mxm_execute_ursa_fifo_w19_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    m_cast8_loc_channel_U : component mxm_execute_ursa_fifo_w18_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
