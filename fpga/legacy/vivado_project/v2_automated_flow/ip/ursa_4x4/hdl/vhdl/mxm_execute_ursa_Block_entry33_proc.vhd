...
entity mxm_execute_ursa_Block_entry33_proc is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of mxm_execute_ursa_Block_entry33_proc is 
...
attribute shreg_extract : string;
    ...
    signal m_cast_out_0_fu_64_p1 : STD_LOGIC_VECTOR (16 downto 0);
    signal zext_ln142_fu_46_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal m_cast4_out_0_fu_60_p1 : STD_LOGIC_VECTOR (17 downto 0);
    signal sub24_out_0_fu_68_p2 : STD_LOGIC_VECTOR (16 downto 0);
...
begin
        ...
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                if (((ap_const_boolean_0 = ap_block_state1) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
                    ap_return_0_preg <= a0_p(15 downto 2);
                end if; 
            end if;
        end if;
    end process;
    ...
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                if (((ap_const_boolean_0 = ap_block_state1) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
                    ap_return_2_preg <= b0_q(15 downto 2);
                end if; 
            end if;
        end if;
    end process;
    ...
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                if (((ap_const_boolean_0 = ap_block_state1) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
                                        ap_return_3_preg(15 downto 0) <= m_cast4_out_0_fu_60_p1(15 downto 0);
                end if; 
            end if;
        end if;
    end process;
    ...
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                if (((ap_const_boolean_0 = ap_block_state1) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
                                        ap_return_4_preg(15 downto 0) <= m_cast_out_0_fu_64_p1(15 downto 0);
                end if; 
            end if;
        end if;
    end process;
    ...
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                if (((ap_const_boolean_0 = ap_block_state1) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
                    ap_return_5_preg <= sub24_out_0_fu_68_p2;
                end if; 
            end if;
        end if;
    end process;
    ...
    ap_return_3_preg(17 downto 16) <= "00";
    ...
    ap_return_3_assign_proc : process(ap_CS_fsm_state1, ap_block_state1, m_cast4_out_0_fu_60_p1, ap_return_3_preg)
    begin
        if (((ap_const_boolean_0 = ap_block_state1) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
            ap_return_3 <= m_cast4_out_0_fu_60_p1;
        else 
    ...
    ap_return_4_assign_proc : process(ap_CS_fsm_state1, ap_block_state1, m_cast_out_0_fu_64_p1, ap_return_4_preg)
    begin
        if (((ap_const_boolean_0 = ap_block_state1) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
            ap_return_4 <= m_cast_out_0_fu_64_p1;
        else 
    ...
    ap_return_5_assign_proc : process(ap_CS_fsm_state1, ap_block_state1, sub24_out_0_fu_68_p2, ap_return_5_preg)
    begin
        if (((ap_const_boolean_0 = ap_block_state1) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
            ap_return_5 <= sub24_out_0_fu_68_p2;
        else 
            ap_return_5 <= ap_return_5_preg;
        end if; 
    end process;

    m_cast4_out_0_fu_60_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(m),18));
    m_cast_out_0_fu_64_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(m),17));
    sub24_out_0_fu_68_p2 <= std_logic_vector(unsigned(m_cast_out_0_fu_64_p1) + unsigned(ap_const_lv17_6));
