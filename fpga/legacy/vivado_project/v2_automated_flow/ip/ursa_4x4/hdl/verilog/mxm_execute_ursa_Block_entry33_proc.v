...
module mxm_execute_ursa_Block_entry33_proc (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg    ap_block_state1;
wire   [16:0] m_cast_out_0_fu_64_p1;
wire   [31:0] zext_ln142_fu_46_p1;
wire   [17:0] m_cast4_out_0_fu_60_p1;
wire   [16:0] sub24_out_0_fu_68_p2;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((1'b0 == ap_block_state1) & (1'b1 == ap_CS_fsm_state1))) begin
                        ap_return_3_preg[15 : 0] <= m_cast4_out_0_fu_60_p1[15 : 0];
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((1'b0 == ap_block_state1) & (1'b1 == ap_CS_fsm_state1))) begin
                        ap_return_4_preg[15 : 0] <= m_cast_out_0_fu_64_p1[15 : 0];
        end
    end
end
...
assign m_cast4_out_0_fu_60_p1 = m;

assign m_cast_out_0_fu_64_p1 = m;

assign sub24_out_0_fu_68_p2 = (m_cast_out_0_fu_64_p1 + 17'd6);

assign zext_ln142_fu_46_p1 = b0_q;

always @ (posedge ap_clk) begin
    ap_return_1_preg[31:16] <= 16'b0000000000000000;
    ap_return_3_preg[17:16] <= 2'b00;
    ap_return_4_preg[16] <= 1'b0;
end

endmodule //mxm_execute_ursa_Block_entry33_proc
