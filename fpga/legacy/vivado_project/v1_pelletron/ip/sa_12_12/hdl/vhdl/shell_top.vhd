...
architecture behav of shell_top is 
    ...
    "shell_top_shell_top,hls_ip_2023_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020-clg484-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=8.151120,HLS_SYN_LAT=-1,HLS_SYN_TPT=-1,HLS_SYN_MEM=8,HLS_SYN_DSP=0,HLS_SYN_FF=13834,HLS_SYN_LUT=16261,HLS_VERSION=2023_2}";
    ...
    signal Block_entry81_proc_U0_ap_start : STD_LOGIC;
    signal Block_entry81_proc_U0_ap_done : STD_LOGIC;
    signal Block_entry81_proc_U0_ap_continue : STD_LOGIC;
    signal Block_entry81_proc_U0_ap_idle : STD_LOGIC;
    signal Block_entry81_proc_U0_ap_ready : STD_LOGIC;
    signal Block_entry81_proc_U0_ap_return_0 : STD_LOGIC_VECTOR (12 downto 0);
    signal Block_entry81_proc_U0_ap_return_1 : STD_LOGIC_VECTOR (31 downto 0);
    signal Block_entry81_proc_U0_ap_return_2 : STD_LOGIC_VECTOR (12 downto 0);
    signal Block_entry81_proc_U0_ap_return_3 : STD_LOGIC_VECTOR (19 downto 0);
    signal Block_entry81_proc_U0_ap_return_4 : STD_LOGIC_VECTOR (18 downto 0);
    signal Block_entry81_proc_U0_ap_return_5 : STD_LOGIC_VECTOR (17 downto 0);
    signal Block_entry81_proc_U0_ap_return_6 : STD_LOGIC_VECTOR (16 downto 0);
    signal Block_entry81_proc_U0_ap_return_7 : STD_LOGIC_VECTOR (16 downto 0);
    ...
    signal ap_channel_done_m_cast20_loc_channel : STD_LOGIC;
    signal m_cast20_loc_channel_full_n : STD_LOGIC;
    signal ap_sync_reg_channel_write_m_cast20_loc_channel : STD_LOGIC := '0';
    signal ap_sync_channel_write_m_cast20_loc_channel : STD_LOGIC;
    signal ap_channel_done_m_cast23_loc_channel : STD_LOGIC;
    signal m_cast23_loc_channel_full_n : STD_LOGIC;
    signal ap_sync_reg_channel_write_m_cast23_loc_channel : STD_LOGIC := '0';
    signal ap_sync_channel_write_m_cast23_loc_channel : STD_LOGIC;
    ...
    signal m_cast23_loc_channel_dout : STD_LOGIC_VECTOR (19 downto 0);
    signal m_cast23_loc_channel_num_data_valid : STD_LOGIC_VECTOR (2 downto 0);
    signal m_cast23_loc_channel_fifo_cap : STD_LOGIC_VECTOR (2 downto 0);
    signal m_cast23_loc_channel_empty_n : STD_LOGIC;
    signal m_cast20_loc_channel_dout : STD_LOGIC_VECTOR (18 downto 0);
    signal m_cast20_loc_channel_num_data_valid : STD_LOGIC_VECTOR (2 downto 0);
    signal m_cast20_loc_channel_fifo_cap : STD_LOGIC_VECTOR (2 downto 0);
    signal m_cast20_loc_channel_empty_n : STD_LOGIC;
    signal m_cast19_loc_channel_dout : STD_LOGIC_VECTOR (17 downto 0);
    ...
    signal ap_sync_reg_Block_entry81_proc_U0_ap_ready : STD_LOGIC := '0';
    signal ap_sync_Block_entry81_proc_U0_ap_ready : STD_LOGIC;
    ...
    component shell_top_Block_entry81_proc IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
...
begin
    ...
    Block_entry81_proc_U0 : component shell_top_Block_entry81_proc
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
        ap_start => Block_entry81_proc_U0_ap_start,
        ap_done => Block_entry81_proc_U0_ap_done,
        ap_continue => Block_entry81_proc_U0_ap_continue,
        ap_idle => Block_entry81_proc_U0_ap_idle,
        ap_ready => Block_entry81_proc_U0_ap_ready,
        a0_p => a0_p,
        b0_q => b0_q,
        m => m,
        ap_return_0 => Block_entry81_proc_U0_ap_return_0,
        ap_return_1 => Block_entry81_proc_U0_ap_return_1,
        ap_return_2 => Block_entry81_proc_U0_ap_return_2,
        ap_return_3 => Block_entry81_proc_U0_ap_return_3,
        ap_return_4 => Block_entry81_proc_U0_ap_return_4,
        ap_return_5 => Block_entry81_proc_U0_ap_return_5,
        ap_return_6 => Block_entry81_proc_U0_ap_return_6,
        ap_return_7 => Block_entry81_proc_U0_ap_return_7);
    ...
    port map (
        ...
        p_read5 => m_cast23_loc_channel_dout,
        p_read6 => m_cast20_loc_channel_dout,
        p_read7 => m_cast19_loc_channel_dout,
        addr_a0 => addr_a0,
    ...
    port map (
        ...
        if_din => Block_entry81_proc_U0_ap_return_0,
    ...
    port map (
        ...
        if_read_ce => ap_const_logic_1,
        if_write_ce => ap_const_logic_1,
        if_din => Block_entry81_proc_U0_ap_return_1,
    ...
    port map (
        ...
        if_read_ce => ap_const_logic_1,
        if_write_ce => ap_const_logic_1,
        if_din => Block_entry81_proc_U0_ap_return_2,
    ...
    m_cast23_loc_channel_U : component shell_top_fifo_w20_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
        if_write_ce => ap_const_logic_1,
        if_din => Block_entry81_proc_U0_ap_return_3,
        if_full_n => m_cast23_loc_channel_full_n,
        if_write => ap_channel_done_m_cast23_loc_channel,
        if_dout => m_cast23_loc_channel_dout,
        if_num_data_valid => m_cast23_loc_channel_num_data_valid,
        if_fifo_cap => m_cast23_loc_channel_fifo_cap,
        if_empty_n => m_cast23_loc_channel_empty_n,
        if_read => Loop_VITIS_LOOP_144_1_proc_U0_ap_ready);

    m_cast20_loc_channel_U : component shell_top_fifo_w19_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
        if_write_ce => ap_const_logic_1,
        if_din => Block_entry81_proc_U0_ap_return_4,
        if_full_n => m_cast20_loc_channel_full_n,
        if_write => ap_channel_done_m_cast20_loc_channel,
        if_dout => m_cast20_loc_channel_dout,
        if_num_data_valid => m_cast20_loc_channel_num_data_valid,
        if_fifo_cap => m_cast20_loc_channel_fifo_cap,
        if_empty_n => m_cast20_loc_channel_empty_n,
        if_read => Loop_VITIS_LOOP_144_1_proc_U0_ap_ready);

    m_cast19_loc_channel_U : component shell_top_fifo_w18_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
        if_write_ce => ap_const_logic_1,
        if_din => Block_entry81_proc_U0_ap_return_5,
    ...
    port map (
        ...
        if_read_ce => ap_const_logic_1,
        if_write_ce => ap_const_logic_1,
        if_din => Block_entry81_proc_U0_ap_return_6,
    ...
    port map (
        ...
        if_read_ce => ap_const_logic_1,
        if_write_ce => ap_const_logic_1,
        if_din => Block_entry81_proc_U0_ap_return_7,
    ...
    ap_sync_reg_Block_entry81_proc_U0_ap_ready_assign_proc : process(ap_clk)
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst_n_inv = '1') then
                ap_sync_reg_Block_entry81_proc_U0_ap_ready <= ap_const_logic_0;
            else
                if (((ap_sync_ready and ap_start) = ap_const_logic_1)) then 
                    ap_sync_reg_Block_entry81_proc_U0_ap_ready <= ap_const_logic_0;
                else 
                    ap_sync_reg_Block_entry81_proc_U0_ap_ready <= ap_sync_Block_entry81_proc_U0_ap_ready;
                end if; 
            end if;
        end if;
    end process;
    ...
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst_n_inv = '1') then
                ...
                if (((Block_entry81_proc_U0_ap_done and Block_entry81_proc_U0_ap_continue) = ap_const_logic_1)) then 
                    ap_sync_reg_channel_write_call_a_cast_loc_channel <= ap_const_logic_0;
                else 
    ...
    ap_sync_reg_channel_write_m_cast20_loc_channel_assign_proc : process(ap_clk)
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst_n_inv = '1') then
                ap_sync_reg_channel_write_m_cast20_loc_channel <= ap_const_logic_0;
            else
                if (((Block_entry81_proc_U0_ap_done and Block_entry81_proc_U0_ap_continue) = ap_const_logic_1)) then 
                    ap_sync_reg_channel_write_m_cast20_loc_channel <= ap_const_logic_0;
                else 
                    ap_sync_reg_channel_write_m_cast20_loc_channel <= ap_sync_channel_write_m_cast20_loc_channel;
                end if; 
            end if;
        end if;
    end process;
    ...
    ap_sync_reg_channel_write_m_cast23_loc_channel_assign_proc : process(ap_clk)
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst_n_inv = '1') then
                ap_sync_reg_channel_write_m_cast23_loc_channel <= ap_const_logic_0;
            else
                if (((Block_entry81_proc_U0_ap_done and Block_entry81_proc_U0_ap_continue) = ap_const_logic_1)) then 
                    ap_sync_reg_channel_write_m_cast23_loc_channel <= ap_const_logic_0;
                else 
                    ap_sync_reg_channel_write_m_cast23_loc_channel <= ap_sync_channel_write_m_cast23_loc_channel;
                end if; 
            end if;
        end if;
    end process;
    ...
    Block_entry81_proc_U0_ap_continue <= (ap_sync_channel_write_zext_ln142_loc_channel and ap_sync_channel_write_sub24_loc_channel and ap_sync_channel_write_m_cast_loc_channel and ap_sync_channel_write_m_cast23_loc_channel and ap_sync_channel_write_m_cast20_loc_channel and ap_sync_channel_write_m_cast19_loc_channel and ap_sync_channel_write_call_b_cast_loc_channel and ap_sync_channel_write_call_a_cast_loc_channel);
    Block_entry81_proc_U0_ap_start <= ((ap_sync_reg_Block_entry81_proc_U0_ap_ready xor ap_const_logic_1) and ap_start);
    Loop_VITIS_LOOP_144_1_proc_U0_ap_continue <= ap_const_logic_1;
    Loop_VITIS_LOOP_144_1_proc_U0_ap_start <= (zext_ln142_loc_channel_empty_n and sub24_loc_channel_empty_n and m_cast_loc_channel_empty_n and m_cast23_loc_channel_empty_n and m_cast20_loc_channel_empty_n and m_cast19_loc_channel_empty_n and (ap_sync_reg_Loop_VITIS_LOOP_144_1_proc_U0_ap_ready xor ap_const_logic_1) and call_b_cast_loc_channel_empty_n and call_a_cast_loc_channel_empty_n and ap_start);
    ap_channel_done_call_a_cast_loc_channel <= ((ap_sync_reg_channel_write_call_a_cast_loc_channel xor ap_const_logic_1) and Block_entry81_proc_U0_ap_done);
    ap_channel_done_call_b_cast_loc_channel <= ((ap_sync_reg_channel_write_call_b_cast_loc_channel xor ap_const_logic_1) and Block_entry81_proc_U0_ap_done);
    ap_channel_done_m_cast19_loc_channel <= ((ap_sync_reg_channel_write_m_cast19_loc_channel xor ap_const_logic_1) and Block_entry81_proc_U0_ap_done);
    ap_channel_done_m_cast20_loc_channel <= ((ap_sync_reg_channel_write_m_cast20_loc_channel xor ap_const_logic_1) and Block_entry81_proc_U0_ap_done);
    ap_channel_done_m_cast23_loc_channel <= ((ap_sync_reg_channel_write_m_cast23_loc_channel xor ap_const_logic_1) and Block_entry81_proc_U0_ap_done);
    ap_channel_done_m_cast_loc_channel <= ((ap_sync_reg_channel_write_m_cast_loc_channel xor ap_const_logic_1) and Block_entry81_proc_U0_ap_done);
    ap_channel_done_sub24_loc_channel <= ((ap_sync_reg_channel_write_sub24_loc_channel xor ap_const_logic_1) and Block_entry81_proc_U0_ap_done);
    ap_channel_done_zext_ln142_loc_channel <= ((ap_sync_reg_channel_write_zext_ln142_loc_channel xor ap_const_logic_1) and Block_entry81_proc_U0_ap_done);
    ap_done <= Loop_VITIS_LOOP_144_1_proc_U0_ap_done;
    ap_idle <= ((sub24_loc_channel_empty_n xor ap_const_logic_1) and (m_cast_loc_channel_empty_n xor ap_const_logic_1) and (m_cast19_loc_channel_empty_n xor ap_const_logic_1) and (m_cast20_loc_channel_empty_n xor ap_const_logic_1) and (m_cast23_loc_channel_empty_n xor ap_const_logic_1) and (call_b_cast_loc_channel_empty_n xor ap_const_logic_1) and (zext_ln142_loc_channel_empty_n xor ap_const_logic_1) and (call_a_cast_loc_channel_empty_n xor ap_const_logic_1) and Loop_VITIS_LOOP_144_1_proc_U0_ap_idle and Block_entry81_proc_U0_ap_idle);
    ...
    ap_sync_Block_entry81_proc_U0_ap_ready <= (ap_sync_reg_Block_entry81_proc_U0_ap_ready or Block_entry81_proc_U0_ap_ready);
    ...
    ap_sync_channel_write_m_cast20_loc_channel <= ((m_cast20_loc_channel_full_n and ap_channel_done_m_cast20_loc_channel) or ap_sync_reg_channel_write_m_cast20_loc_channel);
    ap_sync_channel_write_m_cast23_loc_channel <= ((m_cast23_loc_channel_full_n and ap_channel_done_m_cast23_loc_channel) or ap_sync_reg_channel_write_m_cast23_loc_channel);
    ...
    ap_sync_ready <= (ap_sync_Loop_VITIS_LOOP_144_1_proc_U0_ap_ready and ap_sync_Block_entry81_proc_U0_ap_ready);
