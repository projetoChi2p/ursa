...
entity shell_top_Block_entry_proc_proc is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of shell_top_Block_entry_proc_proc is 
...
begin
    ...
    ap_return_assign_proc : process(ap_CS_fsm_state1, p_read, ap_block_state1, ap_return_preg)
    begin
        if (((ap_const_boolean_0 = ap_block_state1) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
            ap_return <= p_read;
        else 
