...
module shell_top_Block_entry68_proc (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire   [16:0] m_cast_out_0_fu_94_p1;
wire   [31:0] zext_ln142_fu_58_p1;
wire   [19:0] m_cast19_out_0_fu_82_p1;
wire   [18:0] m_cast16_out_0_fu_86_p1;
wire   [17:0] m_cast15_out_0_fu_90_p1;
wire   [16:0] sub24_out_0_fu_98_p2;
wire   [31:0] zext_ln144_fu_104_p1;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((1'b0 == ap_block_state1) & (1'b1 == ap_CS_fsm_state1))) begin
            ap_return_0_preg <= {{mul_ln141_fu_42_p2[32:20]}};
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((1'b0 == ap_block_state1) & (1'b1 == ap_CS_fsm_state1))) begin
            ap_return_2_preg <= {{mul_ln142_fu_66_p2[32:20]}};
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((1'b0 == ap_block_state1) & (1'b1 == ap_CS_fsm_state1))) begin
                        ap_return_3_preg[15 : 0] <= m_cast19_out_0_fu_82_p1[15 : 0];
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((1'b0 == ap_block_state1) & (1'b1 == ap_CS_fsm_state1))) begin
                        ap_return_4_preg[15 : 0] <= m_cast16_out_0_fu_86_p1[15 : 0];
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((1'b0 == ap_block_state1) & (1'b1 == ap_CS_fsm_state1))) begin
                        ap_return_5_preg[15 : 0] <= m_cast15_out_0_fu_90_p1[15 : 0];
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((1'b0 == ap_block_state1) & (1'b1 == ap_CS_fsm_state1))) begin
                        ap_return_6_preg[15 : 0] <= m_cast_out_0_fu_94_p1[15 : 0];
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((1'b0 == ap_block_state1) & (1'b1 == ap_CS_fsm_state1))) begin
                        ap_return_8_preg[15 : 0] <= zext_ln144_fu_104_p1[15 : 0];
        end
    end
end
...
always @ (*) begin
    if (((1'b0 == ap_block_state1) & (1'b1 == ap_CS_fsm_state1))) begin
        ap_return_0 = {{mul_ln141_fu_42_p2[32:20]}};
    end else begin
...
always @ (*) begin
    if (((1'b0 == ap_block_state1) & (1'b1 == ap_CS_fsm_state1))) begin
        ap_return_2 = {{mul_ln142_fu_66_p2[32:20]}};
    end else begin
...
assign m_cast15_out_0_fu_90_p1 = m;

assign m_cast16_out_0_fu_86_p1 = m;

assign m_cast19_out_0_fu_82_p1 = m;

assign m_cast_out_0_fu_94_p1 = m;

assign mul_ln141_fu_42_p0 = mul_ln141_fu_42_p00;

assign mul_ln141_fu_42_p00 = a0_p;

assign mul_ln141_fu_42_p1 = 33'd104858;

assign mul_ln142_fu_66_p0 = mul_ln142_fu_66_p00;

assign mul_ln142_fu_66_p00 = b0_q;

assign mul_ln142_fu_66_p1 = 33'd104858;

assign sub24_out_0_fu_98_p2 = (m_cast_out_0_fu_94_p1 + 17'd18);

assign zext_ln142_fu_58_p1 = b0_q;

assign zext_ln144_fu_104_p1 = m;

always @ (posedge ap_clk) begin
    ap_return_1_preg[31:16] <= 16'b0000000000000000;
    ap_return_3_preg[19:16] <= 4'b0000;
    ap_return_4_preg[18:16] <= 3'b000;
    ap_return_5_preg[17:16] <= 2'b00;
    ap_return_6_preg[16] <= 1'b0;
    ap_return_8_preg[31:16] <= 16'b0000000000000000;
end

endmodule //shell_top_Block_entry68_proc
