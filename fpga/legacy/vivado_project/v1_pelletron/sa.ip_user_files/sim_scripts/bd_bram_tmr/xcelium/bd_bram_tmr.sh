...
#
# Script generated by Vivado on Sun May 11 11:19:56 -03 2025
# SW Build 4029153 on Fri Oct 13 20:13:54 MDT 2023
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2023 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : bd_bram_tmr.sh
...
#
# Usage        : bd_bram_tmr.sh
#                bd_bram_tmr.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                bd_bram_tmr.sh [-reset_run]
#                bd_bram_tmr.sh [-reset_log]
#                bd_bram_tmr.sh [-help]
#
...
#                script (type 'bd_bram_tmr.sh -help' for more information).
#
...
# script info
echo -e "bd_bram_tmr.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./bd_bram_tmr.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  xmvlog -work xilinx_vip $xmvlog_opts -sv +incdir+"../../../../sa.gen/sources_1/bd/bd_bram_tmr/ipshared/ec67/hdl" +incdir+"../../../../sa.gen/sources_1/bd/bd_bram_tmr/ipshared/6b2b/hdl" +incdir+"../../../../sa.gen/sources_1/bd/bd_bram_tmr/ipshared/971c/hdl/verilog" +incdir+"../../../../sa.gen/sources_1/bd/bd_bram_tmr/ip/bd_bram_tmr_shell_top_0_0_1/drivers/shell_top_v1_0/src" +incdir+"/opt/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  ...
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../../sa.gen/sources_1/bd/bd_bram_tmr/ipshared/ec67/hdl" +incdir+"../../../../sa.gen/sources_1/bd/bd_bram_tmr/ipshared/6b2b/hdl" +incdir+"../../../../sa.gen/sources_1/bd/bd_bram_tmr/ipshared/971c/hdl/verilog" +incdir+"../../../../sa.gen/sources_1/bd/bd_bram_tmr/ip/bd_bram_tmr_shell_top_0_0_1/drivers/shell_top_v1_0/src" +incdir+"/opt/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  ...
  xmvlog -work axi_infrastructure_v1_1_0 $xmvlog_opts +incdir+"../../../../sa.gen/sources_1/bd/bd_bram_tmr/ipshared/ec67/hdl" +incdir+"../../../../sa.gen/sources_1/bd/bd_bram_tmr/ipshared/6b2b/hdl" +incdir+"../../../../sa.gen/sources_1/bd/bd_bram_tmr/ipshared/971c/hdl/verilog" +incdir+"../../../../sa.gen/sources_1/bd/bd_bram_tmr/ip/bd_bram_tmr_shell_top_0_0_1/drivers/shell_top_v1_0/src" +incdir+"/opt/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  "../../../../sa.gen/sources_1/bd/bd_bram_tmr/ipshared/ec67/hdl/axi_infrastructure_v1_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work axi_vip_v1_1_15 $xmvlog_opts -sv +incdir+"../../../../sa.gen/sources_1/bd/bd_bram_tmr/ipshared/ec67/hdl" +incdir+"../../../../sa.gen/sources_1/bd/bd_bram_tmr/ipshared/6b2b/hdl" +incdir+"../../../../sa.gen/sources_1/bd/bd_bram_tmr/ipshared/971c/hdl/verilog" +incdir+"../../../../sa.gen/sources_1/bd/bd_bram_tmr/ip/bd_bram_tmr_shell_top_0_0_1/drivers/shell_top_v1_0/src" +incdir+"/opt/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  "../../../../sa.gen/sources_1/bd/bd_bram_tmr/ipshared/5753/hdl/axi_vip_v1_1_vl_rfs.sv" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work processing_system7_vip_v1_0_17 $xmvlog_opts -sv +incdir+"../../../../sa.gen/sources_1/bd/bd_bram_tmr/ipshared/ec67/hdl" +incdir+"../../../../sa.gen/sources_1/bd/bd_bram_tmr/ipshared/6b2b/hdl" +incdir+"../../../../sa.gen/sources_1/bd/bd_bram_tmr/ipshared/971c/hdl/verilog" +incdir+"../../../../sa.gen/sources_1/bd/bd_bram_tmr/ip/bd_bram_tmr_shell_top_0_0_1/drivers/shell_top_v1_0/src" +incdir+"/opt/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  "../../../../sa.gen/sources_1/bd/bd_bram_tmr/ipshared/6b2b/hdl/processing_system7_vip_v1_0_vl_rfs.sv" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../../sa.gen/sources_1/bd/bd_bram_tmr/ipshared/ec67/hdl" +incdir+"../../../../sa.gen/sources_1/bd/bd_bram_tmr/ipshared/6b2b/hdl" +incdir+"../../../../sa.gen/sources_1/bd/bd_bram_tmr/ipshared/971c/hdl/verilog" +incdir+"../../../../sa.gen/sources_1/bd/bd_bram_tmr/ip/bd_bram_tmr_shell_top_0_0_1/drivers/shell_top_v1_0/src" +incdir+"/opt/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  ...
  xmvlog -work generic_baseblocks_v2_1_1 $xmvlog_opts +incdir+"../../../../sa.gen/sources_1/bd/bd_bram_tmr/ipshared/ec67/hdl" +incdir+"../../../../sa.gen/sources_1/bd/bd_bram_tmr/ipshared/6b2b/hdl" +incdir+"../../../../sa.gen/sources_1/bd/bd_bram_tmr/ipshared/971c/hdl/verilog" +incdir+"../../../../sa.gen/sources_1/bd/bd_bram_tmr/ip/bd_bram_tmr_shell_top_0_0_1/drivers/shell_top_v1_0/src" +incdir+"/opt/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  "../../../../sa.gen/sources_1/bd/bd_bram_tmr/ipshared/10ab/hdl/generic_baseblocks_v2_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work axi_register_slice_v2_1_29 $xmvlog_opts +incdir+"../../../../sa.gen/sources_1/bd/bd_bram_tmr/ipshared/ec67/hdl" +incdir+"../../../../sa.gen/sources_1/bd/bd_bram_tmr/ipshared/6b2b/hdl" +incdir+"../../../../sa.gen/sources_1/bd/bd_bram_tmr/ipshared/971c/hdl/verilog" +incdir+"../../../../sa.gen/sources_1/bd/bd_bram_tmr/ip/bd_bram_tmr_shell_top_0_0_1/drivers/shell_top_v1_0/src" +incdir+"/opt/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  "../../../../sa.gen/sources_1/bd/bd_bram_tmr/ipshared/ff9f/hdl/axi_register_slice_v2_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work fifo_generator_v13_2_9 $xmvlog_opts +incdir+"../../../../sa.gen/sources_1/bd/bd_bram_tmr/ipshared/ec67/hdl" +incdir+"../../../../sa.gen/sources_1/bd/bd_bram_tmr/ipshared/6b2b/hdl" +incdir+"../../../../sa.gen/sources_1/bd/bd_bram_tmr/ipshared/971c/hdl/verilog" +incdir+"../../../../sa.gen/sources_1/bd/bd_bram_tmr/ip/bd_bram_tmr_shell_top_0_0_1/drivers/shell_top_v1_0/src" +incdir+"/opt/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  ...
  xmvlog -work axi_data_fifo_v2_1_28 $xmvlog_opts +incdir+"../../../../sa.gen/sources_1/bd/bd_bram_tmr/ipshared/ec67/hdl" +incdir+"../../../../sa.gen/sources_1/bd/bd_bram_tmr/ipshared/6b2b/hdl" +incdir+"../../../../sa.gen/sources_1/bd/bd_bram_tmr/ipshared/971c/hdl/verilog" +incdir+"../../../../sa.gen/sources_1/bd/bd_bram_tmr/ip/bd_bram_tmr_shell_top_0_0_1/drivers/shell_top_v1_0/src" +incdir+"/opt/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  "../../../../sa.gen/sources_1/bd/bd_bram_tmr/ipshared/279e/hdl/axi_data_fifo_v2_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work axi_crossbar_v2_1_30 $xmvlog_opts +incdir+"../../../../sa.gen/sources_1/bd/bd_bram_tmr/ipshared/ec67/hdl" +incdir+"../../../../sa.gen/sources_1/bd/bd_bram_tmr/ipshared/6b2b/hdl" +incdir+"../../../../sa.gen/sources_1/bd/bd_bram_tmr/ipshared/971c/hdl/verilog" +incdir+"../../../../sa.gen/sources_1/bd/bd_bram_tmr/ip/bd_bram_tmr_shell_top_0_0_1/drivers/shell_top_v1_0/src" +incdir+"/opt/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  ...
  xmvlog -work blk_mem_gen_v8_4_7 $xmvlog_opts +incdir+"../../../../sa.gen/sources_1/bd/bd_bram_tmr/ipshared/ec67/hdl" +incdir+"../../../../sa.gen/sources_1/bd/bd_bram_tmr/ipshared/6b2b/hdl" +incdir+"../../../../sa.gen/sources_1/bd/bd_bram_tmr/ipshared/971c/hdl/verilog" +incdir+"../../../../sa.gen/sources_1/bd/bd_bram_tmr/ip/bd_bram_tmr_shell_top_0_0_1/drivers/shell_top_v1_0/src" +incdir+"/opt/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  ...
  xmvlog -work axi_protocol_converter_v2_1_29 $xmvlog_opts +incdir+"../../../../sa.gen/sources_1/bd/bd_bram_tmr/ipshared/ec67/hdl" +incdir+"../../../../sa.gen/sources_1/bd/bd_bram_tmr/ipshared/6b2b/hdl" +incdir+"../../../../sa.gen/sources_1/bd/bd_bram_tmr/ipshared/971c/hdl/verilog" +incdir+"../../../../sa.gen/sources_1/bd/bd_bram_tmr/ip/bd_bram_tmr_shell_top_0_0_1/drivers/shell_top_v1_0/src" +incdir+"/opt/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.bd_bram_tmr xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.bd_bram_tmr -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log bd_bram_tmr_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./bd_bram_tmr.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: bd_bram_tmr.sh [-help]\n\
Usage: bd_bram_tmr.sh [-step]\n\
Usage: bd_bram_tmr.sh [-lib_map_path]\n\
Usage: bd_bram_tmr.sh [-reset_run]\n\
Usage: bd_bram_tmr.sh [-reset_log]\n\
Usage: bd_bram_tmr.sh [-keep_index]\n\
Usage: bd_bram_tmr.sh [-noclean_files]\n\n\
