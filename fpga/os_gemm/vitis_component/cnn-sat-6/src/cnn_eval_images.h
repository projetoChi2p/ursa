...
/* Must match the generated cnn_eval_images_*.cpp. main checks it against
   g_total_num_images at startup and refuses to run if they disagree. */
#ifndef TOTAL_NUM_IMAGES
    #define TOTAL_NUM_IMAGES 18
#endif
