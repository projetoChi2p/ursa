...
#define CNN_NETWORK_T2  //definido pelo usuário (automação)
#define MAX_WH_KERNEL 3 //definido pelo usuário (automação)
    ...
    // ---------- CONV4 ----------
    #define CONV4_ROW              (CONV4_CH_OUT)
    #define CONV4_COL              (CONV4_WH_KERNEL * CONV4_WH_KERNEL * CONV4_CH_IN)
    #define CONV4_PADDED_ROW       (((CONV4_ROW + SA_SIZE - 1) / SA_SIZE) * SA_SIZE)
    // #define CONV4_PADDED_COL       (((CONV4_COL + SA_SIZE - 1) / SA_SIZE) * SA_SIZE)
    // #define TOTAL_NUM_WEIGHTS_WITH_PADDING_4  (CONV4_PADDED_ROW * CONV4_PADDED_COL)


    #define TOTAL_NUM_WEIGHTS_WITH_PADDING_4  (CONV4_PADDED_ROW * CONV4_COL) //não precisa corrigir o padding de colunas (M)
    ...
    #define TOTAL_NUM_WEIGHTS ( \
        ...
        TOTAL_NUM_WEIGHTS_WITH_PADDING_4 )
    ...
    // Início da CONV4: logo após o bloco de CONV3
    #define ADDR_WEIGHTS_CONV4  (ADDR_WEIGHTS_CONV3 + TOTAL_NUM_WEIGHTS_WITH_PADDING_3)  //
