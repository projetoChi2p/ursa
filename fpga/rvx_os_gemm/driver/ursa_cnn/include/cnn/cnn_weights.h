...
/************** Result Tab **********************/
	typedef struct {
		int32_t in_tab[256];
	} weigths_tab_result_t;

	extern int32_t max_value_tab_1;
    extern int32_t max_value_tab_2;
    extern int32_t max_value_tab_3;
	extern int32_t max_value_tab_4;

	extern weigths_tab_result_t weigths_tab_result_1;
	extern weigths_tab_result_t weigths_tab_result_2;
	extern weigths_tab_result_t weigths_tab_result_3;
	extern weigths_tab_result_t weigths_tab_result_4;
