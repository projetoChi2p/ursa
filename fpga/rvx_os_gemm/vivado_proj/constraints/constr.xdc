...
#zybo
#set_property -dict { PACKAGE_PIN V12   IOSTANDARD LVCMOS33 } [get_ports { JE1 }]; #IO_L4P_T0_34 Sch=JE1
#set_property -dict { PACKAGE_PIN W16   IOSTANDARD LVCMOS33 } [get_ports { JE2 }]; #IO_L18N_T2_34 Sch=JE2
#zed
set_property PACKAGE_PIN Y11  [get_ports {JE1}];  # "JA1"
set_property PACKAGE_PIN AA11 [get_ports {JE2}];  # "JA2"

# Pull-up RXD
set_property PULLTYPE PULLUP [get_ports JE2]
...
set_property PACKAGE_PIN P16 [get_ports {BTN0}];  # "BTNC to BTN0"
...
set_property DONT_TOUCH true [get_cells -quiet -hierarchical -filter { NAME =~ bd_axi_i}]
set_property DONT_TOUCH true [get_cells -quiet -hierarchical -filter { NAME =~ bd_ps7_i}]
set_property DONT_TOUCH true [get_cells -quiet -hierarchical -filter { NAME =~ rvx_i}]
set_property DONT_TOUCH true [get_cells -quiet -hierarchical -filter { NAME =~ rvx_i/rvx_axi_instance}]
set_property DONT_TOUCH true [get_cells -quiet -hierarchical -filter { NAME =~ rvx_i/rvx_bus_instance}]
set_property DONT_TOUCH true [get_cells -quiet -hierarchical -filter { NAME =~ rvx_i/rvx_core_instance}]
set_property DONT_TOUCH true [get_cells -quiet -hierarchical -filter { NAME =~ rvx_i/rvx_gpio_instance}]
set_property DONT_TOUCH true [get_cells -quiet -hierarchical -filter { NAME =~ rvx_i/rvx_mtimer_instance}]
set_property DONT_TOUCH true [get_cells -quiet -hierarchical -filter { NAME =~ rvx_i/rvx_ram_instance}]
set_property DONT_TOUCH true [get_cells -quiet -hierarchical -filter { NAME =~ rvx_i/rvx_uart_instance}]
