# 1 "/home/fi/Documents/GitHub/ursa/src/im2col/im2col.cpp"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 376 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "/home/fi/Documents/GitHub/ursa/src/im2col/im2col.cpp" 2
# 1 "/home/fi/Documents/GitHub/ursa/src/im2col/im2col.h" 1



# 1 "/opt/Xilinx/Vitis_HLS/2023.2/tps/lnx64/gcc-8.3.0/lib/gcc/x86_64-pc-linux-gnu/8.3.0/../../../../include/c++/8.3.0/cstring" 1 3
# 40 "/opt/Xilinx/Vitis_HLS/2023.2/tps/lnx64/gcc-8.3.0/lib/gcc/x86_64-pc-linux-gnu/8.3.0/../../../../include/c++/8.3.0/cstring" 3
...
# 42 "/opt/Xilinx/Vitis_HLS/2023.2/tps/lnx64/gcc-8.3.0/lib/gcc/x86_64-pc-linux-gnu/8.3.0/../../../../include/c++/8.3.0/cstring" 2 3
...
# 43 "/opt/Xilinx/Vitis_HLS/2023.2/tps/lnx64/gcc-8.3.0/lib/gcc/x86_64-pc-linux-gnu/8.3.0/../../../../include/c++/8.3.0/cstring" 2 3
# 71 "/opt/Xilinx/Vitis_HLS/2023.2/tps/lnx64/gcc-8.3.0/lib/gcc/x86_64-pc-linux-gnu/8.3.0/../../../../include/c++/8.3.0/cstring" 3
namespace std __attribute__ ((__visibility__ ("default")))
{
  ...
  using ::strrchr;
  using ::strstr;
# 121 "/opt/Xilinx/Vitis_HLS/2023.2/tps/lnx64/gcc-8.3.0/lib/gcc/x86_64-pc-linux-gnu/8.3.0/../../../../include/c++/8.3.0/cstring" 3
}
# 5 "/home/fi/Documents/GitHub/ursa/src/im2col/im2col.h" 2

# 1 "/home/fi/Documents/GitHub/ursa/src/im2col/../settings.h" 1
...
# 5 "/home/fi/Documents/GitHub/ursa/src/im2col/../settings.h" 2
...
# 6 "/home/fi/Documents/GitHub/ursa/src/im2col/../settings.h" 2
...
# 8 "/home/fi/Documents/GitHub/ursa/src/im2col/../settings.h" 2
...
# 15 "/home/fi/Documents/GitHub/ursa/src/im2col/../settings.h" 2
# 40 "/home/fi/Documents/GitHub/ursa/src/im2col/../settings.h"
...
# 41 "/home/fi/Documents/GitHub/ursa/src/im2col/../settings.h" 2
...
# 130 "/home/fi/Documents/GitHub/ursa/src/im2col/../settings.h"
...
# 7 "/home/fi/Documents/GitHub/ursa/src/im2col/im2col.h" 2
# 1 "/home/fi/Documents/GitHub/ursa/src/im2col/../core/sa.h" 1



# 1 "/home/fi/Documents/GitHub/ursa/src/im2col/../core/pe.h" 1
...
# 5 "/home/fi/Documents/GitHub/ursa/src/im2col/../core/sa.h" 2

typedef struct {
   PE pe[9][9];
   data_a_t in_mtx_a_li[9];
   data_b_t in_mtx_b_tw[9];
}SA;
...
void sa_reset(SA *sa);
# 8 "/home/fi/Documents/GitHub/ursa/src/im2col/im2col.h" 2
...
# 2 "/home/fi/Documents/GitHub/ursa/src/im2col/im2col.cpp" 2
...
int populate_scratchpad_bi_with_im2col_2(
    ...
    VITIS_LOOP_39_1: for (uint8_t channel = channels; channel--; data_im += channel_size) {
        VITIS_LOOP_40_2: for (uint8_t kernel_row = 0; kernel_row < kernel_h; kernel_row++) {
            VITIS_LOOP_41_3: for (uint8_t kernel_col = 0; kernel_col < kernel_w; kernel_col++) {

                int input_row = -pad_h + kernel_row;

                VITIS_LOOP_45_4: for (int output_rows = output_h; output_rows; output_rows--) {
                    if (!is_a_ge_zero_and_a_lt_b(input_row, height)) {
                        VITIS_LOOP_47_5: for (int output_cols = output_w; output_cols; output_cols--) {
                            *(data_col++) = 0;
                        }
                    }
                    else {
                        ...
                        VITIS_LOOP_54_6: for (int output_col = output_w; output_col; output_col--) {
                ...
                VITIS_LOOP_66_7: for (int k = (output_h*output_w); k < aligned_wh_out; k++) {
                    *(data_col++) = 0;
                }
            }
        }
...
int populate_bi_with_im2col_2(
    ...
    VITIS_LOOP_113_1: for (uint8_t channel = channels; channel--; data_im += channel_size) {
#pragma HLS LOOP_FLATTE
 VITIS_LOOP_115_2: for (uint8_t kernel_row = 0; kernel_row < kernel_h; kernel_row++) {
            VITIS_LOOP_116_3: for (uint8_t kernel_col = 0; kernel_col < kernel_w; kernel_col++) {

                int input_row = -pad_h + kernel_row;

                VITIS_LOOP_120_4: for (int output_rows = output_h; output_rows; output_rows--) {
                    int input_col = -pad_w + kernel_col;
                    bool row_valid = is_a_ge_zero_and_a_lt_b(input_row, height);


                    VITIS_LOOP_125_5: for (int output_col = output_w; output_col; output_col--) {
#pragma HLS PIPELINE II=1
 bool col_valid = is_a_ge_zero_and_a_lt_b(input_col, width);
                        *(data_col++) = (row_valid && col_valid) ?
                            (data_b_t)(data_im[input_row * width + input_col]) :
                            (data_b_t)(0);
                        input_col += stride_w;
                    }
                    input_row += stride_h;
                ...
                VITIS_LOOP_137_6: for (int k = (output_h * output_w); k < aligned_wh_out; k++) {
#pragma HLS PIPELINE II=1
 *(data_col++) = (data_b_t)(0);
                }
            }
