# 1 "/home/fi/Documents/GitHub/ursa/src/core/shell.cpp"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 376 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "/home/fi/Documents/GitHub/ursa/src/core/shell.cpp" 2
# 1 "/home/fi/Documents/GitHub/ursa/src/core/shell.h" 1



# 1 "/home/fi/Documents/GitHub/ursa/src/core/sa.h" 1



# 1 "/home/fi/Documents/GitHub/ursa/src/core/pe.h" 1



# 1 "/home/fi/Documents/GitHub/ursa/src/core/../settings.h" 1
...
# 5 "/home/fi/Documents/GitHub/ursa/src/core/../settings.h" 2
...
# 6 "/home/fi/Documents/GitHub/ursa/src/core/../settings.h" 2
...
# 8 "/home/fi/Documents/GitHub/ursa/src/core/../settings.h" 2
...
# 15 "/home/fi/Documents/GitHub/ursa/src/core/../settings.h" 2
# 40 "/home/fi/Documents/GitHub/ursa/src/core/../settings.h"
...
# 41 "/home/fi/Documents/GitHub/ursa/src/core/../settings.h" 2
...
# 130 "/home/fi/Documents/GitHub/ursa/src/core/../settings.h"
...
# 5 "/home/fi/Documents/GitHub/ursa/src/core/pe.h" 2
...
# 5 "/home/fi/Documents/GitHub/ursa/src/core/sa.h" 2
...
void sa_reset(SA *sa);
# 5 "/home/fi/Documents/GitHub/ursa/src/core/shell.h" 2
# 2 "/home/fi/Documents/GitHub/ursa/src/core/shell.cpp" 2


void fill_inputs_a(data_a_t *addr_a, data_a_t in_a[9], uint16_t t, uint16_t m){
    data_a_t value_a;
...
#pragma HLS PIPELINE II=1
 VITIS_LOOP_12_1: for(uint16_t i=0;i<9;i++){
#pragma HLS UNROLL
...
void fill_inputs_b(data_b_t *addr_b, uint16_t str_b, data_b_t in_b[9] ,uint16_t t, uint16_t m){
    data_b_t value_b;
...
#pragma HLS PIPELINE II=1
 VITIS_LOOP_40_1: for(uint16_t j=0;j<9;j++){
#pragma HLS UNROLL
...
void load_inputs_sa(SA *sa, data_a_t in_a[9], data_b_t in_b[9]){
#pragma HLS PIPELINE II=1

 VITIS_LOOP_63_1: for(uint16_t k=0;k<9;k++) {
#pragma HLS UNROLL factor=9
 sa_input_a_b(sa,in_a[k],in_b[k],k);
    }
}
# 139 "/home/fi/Documents/GitHub/ursa/src/core/shell.cpp"
        __attribute__((sdx_kernel("mxm_execute_ursa", 0))) sa_result_t mxm_execute_ursa(
            int8_t *addr_a0,
            uint16_t a0_p,
            uint8_t *addr_b0,
...
# 151 "/home/fi/Documents/GitHub/ursa/src/core/shell.cpp"
...
# 178 "/home/fi/Documents/GitHub/ursa/src/core/shell.cpp"
    data_b_t *casted_b0 = (data_b_t*)addr_b0;
# 201 "/home/fi/Documents/GitHub/ursa/src/core/shell.cpp"
...
# 226 "/home/fi/Documents/GitHub/ursa/src/core/shell.cpp"
...
# 244 "/home/fi/Documents/GitHub/ursa/src/core/shell.cpp"
 data_a_t in_a[9];
...
#pragma HLS DATAFLOW
 sa_init(&sa);
        uint16_t call_a = a0_p/9;
        uint16_t call_b = b0_q/9;

        VITIS_LOOP_267_1: for(uint16_t i=0;i<call_a;i++){
            VITIS_LOOP_268_2: for(uint16_t j=0;j<call_b;j++){
                addr_sa_a = (data_a_t*)(casted_a0 + i * 9 * m);
                addr_sa_b = (data_b_t*)(casted_b0 + j * 9);
# 283 "/home/fi/Documents/GitHub/ursa/src/core/shell.cpp"
                uint16_t t=0;
                VITIS_LOOP_284_3: for(uint16_t k=0;k<m+9 -1+9 -1;k++){
#pragma HLS PIPELINE II=1
 ...
 fill_inputs_a(addr_sa_a,in_a,t,m);
                ...
                addr_sa_c = (data_c_t*)(casted_c0 + (i*9*b0_q) + (j*9));
                sa_store(&sa,addr_sa_c,b0_q);
                sa_reset(&sa);
# 338 "/home/fi/Documents/GitHub/ursa/src/core/shell.cpp"
            }
        }
    }
