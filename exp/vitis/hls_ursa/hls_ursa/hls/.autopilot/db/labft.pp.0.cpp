# 1 "/home/fi/Documents/GitHub/ursa/src/labft/labft.cpp"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 376 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "/home/fi/Documents/GitHub/ursa/src/labft/labft.cpp" 2
# 1 "/home/fi/Documents/GitHub/ursa/src/labft/labft.h" 1



# 1 "/home/fi/Documents/GitHub/ursa/src/labft/../settings.h" 1
...
# 5 "/home/fi/Documents/GitHub/ursa/src/labft/../settings.h" 2
...
# 6 "/home/fi/Documents/GitHub/ursa/src/labft/../settings.h" 2
...
# 8 "/home/fi/Documents/GitHub/ursa/src/labft/../settings.h" 2
...
# 15 "/home/fi/Documents/GitHub/ursa/src/labft/../settings.h" 2
# 40 "/home/fi/Documents/GitHub/ursa/src/labft/../settings.h"
...
# 41 "/home/fi/Documents/GitHub/ursa/src/labft/../settings.h" 2
...
# 130 "/home/fi/Documents/GitHub/ursa/src/labft/../settings.h"
...
# 5 "/home/fi/Documents/GitHub/ursa/src/labft/labft.h" 2
...
# 2 "/home/fi/Documents/GitHub/ursa/src/labft/labft.cpp" 2
...
labft_acc_t labft_compute_L(data_a_t *a, data_b_t *b, int p, int m, int q)
{
    ...
    VITIS_LOOP_11_1: for (int z = 0; z < m; z++) {
        labft_acc_t sva = 0;
        labft_acc_t svb = 0;


        VITIS_LOOP_16_2: for (int i = 0; i < p; i++) {
            sva += (labft_acc_t)a[i * m + z];
        }


        VITIS_LOOP_21_3: for (int j = 0; j < q; j++) {
...
labft_acc_t labft_compute_Lc(data_c_t *c, int p, int q)
{
    ...
    VITIS_LOOP_45_1: for (int i = 0; i < p; i++) {
        VITIS_LOOP_46_2: for (int j = 0; j < q; j++) {
...
# 98 "/home/fi/Documents/GitHub/ursa/src/labft/labft.cpp"
labft_acc_t labft_compute_L_tile(data_a_t *a_tile, data_b_t *b_tile,
                                  int sa_size, int m, int b_stride)
{
    labft_acc_t L = 0;

    VITIS_LOOP_103_1: for (int z = 0; z < m; z++) {
        labft_acc_t sva = 0;
        labft_acc_t svb = 0;


        VITIS_LOOP_108_2: for (int i = 0; i < sa_size; i++)
            sva += (labft_acc_t)a_tile[i * m + z];




        VITIS_LOOP_114_3: for (int j = 0; j < sa_size; j++)
...
labft_acc_t labft_compute_Lc_tile(data_c_t *c_tile, int sa_size, int c_stride)
{
    ...
    VITIS_LOOP_136_1: for (int i = 0; i < sa_size; i++)
        VITIS_LOOP_137_2: for (int j = 0; j < sa_size; j++)
