...
HD_PWD='/home/fi/Documents/GitHub/ursa/exp/vivado/ursa_vanilla/ursa_vanilla.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ursa_vanilla_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ursa_vanilla_wrapper.tcl
