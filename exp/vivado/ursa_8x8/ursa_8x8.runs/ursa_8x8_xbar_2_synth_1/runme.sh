...
HD_PWD='/home/fi/Documents/GitHub/ursa/exp/vivado/ursa_8x8/ursa_8x8.runs/ursa_8x8_xbar_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ursa_8x8_xbar_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ursa_8x8_xbar_2.tcl
