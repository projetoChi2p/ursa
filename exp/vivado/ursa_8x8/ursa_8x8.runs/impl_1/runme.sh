...
HD_PWD='/home/fi/Documents/GitHub/ursa/exp/vivado/ursa_8x8/ursa_8x8.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ursa_8x8_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ursa_8x8_wrapper.tcl -notrace
