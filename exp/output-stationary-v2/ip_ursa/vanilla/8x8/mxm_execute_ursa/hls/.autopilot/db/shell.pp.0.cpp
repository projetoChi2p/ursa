# 1 "/home/ulisses/Projects/ursa/exp/output-stationary-v2/sources/vanilla/src/core/shell.cpp"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 376 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "/home/ulisses/Projects/ursa/exp/output-stationary-v2/sources/vanilla/src/core/shell.cpp" 2
# 1 "/home/ulisses/Projects/ursa/exp/output-stationary-v2/sources/vanilla/src/core/shell.h" 1



# 1 "/home/ulisses/Projects/ursa/exp/output-stationary-v2/sources/vanilla/src/core/sa.h" 1



# 1 "/home/ulisses/Projects/ursa/exp/output-stationary-v2/sources/vanilla/src/core/pe.h" 1



# 1 "/home/ulisses/Projects/ursa/exp/output-stationary-v2/sources/vanilla/src/core/../settings.h" 1
...
# 5 "/home/ulisses/Projects/ursa/exp/output-stationary-v2/sources/vanilla/src/core/../settings.h" 2
...
# 6 "/home/ulisses/Projects/ursa/exp/output-stationary-v2/sources/vanilla/src/core/../settings.h" 2
...
# 199 "/usr/include/limits.h" 2 3 4



# 1 "/usr/include/x86_64-linux-gnu/bits/posix2_lim.h" 1 3 4
# 203 "/usr/include/limits.h" 2 3 4
...
# 207 "/usr/include/limits.h" 2 3 4
# 38 "/opt/Xilinx/Vitis_HLS/2023.2/lnx64/tools/clang-3.9-csynth/lib/clang/7.0.0/include/limits.h" 2 3
# 8 "/home/ulisses/Projects/ursa/exp/output-stationary-v2/sources/vanilla/src/core/../settings.h" 2
# 61 "/home/ulisses/Projects/ursa/exp/output-stationary-v2/sources/vanilla/src/core/../settings.h"
...
# 62 "/home/ulisses/Projects/ursa/exp/output-stationary-v2/sources/vanilla/src/core/../settings.h" 2
    ...
    typedef ap_uint<8*8> sa_word_t;
    typedef sa_word_t a_word_t;
    typedef sa_word_t b_word_t;
# 79 "/home/ulisses/Projects/ursa/exp/output-stationary-v2/sources/vanilla/src/core/../settings.h"
...
# 5 "/home/ulisses/Projects/ursa/exp/output-stationary-v2/sources/vanilla/src/core/pe.h" 2
...
# 5 "/home/ulisses/Projects/ursa/exp/output-stationary-v2/sources/vanilla/src/core/sa.h" 2
...
void sa_reset(SA *sa);
# 5 "/home/ulisses/Projects/ursa/exp/output-stationary-v2/sources/vanilla/src/core/shell.h" 2
# 2 "/home/ulisses/Projects/ursa/exp/output-stationary-v2/sources/vanilla/src/core/shell.cpp" 2
# 45 "/home/ulisses/Projects/ursa/exp/output-stationary-v2/sources/vanilla/src/core/shell.cpp"
static void fill_inputs_a(const a_word_t a_buf[8][(256 / 8)],
                          data_a_t in_a[8], uint16_t t, uint16_t m)
{
#pragma HLS INLINE
...
#pragma HLS UNROLL
 ...
 if (t >= i && t < i + m) {
            const uint16_t k = m - 1 - (t - i);
            const uint16_t wi = k / 8;
            const uint16_t by = k % 8;
...
static void fill_inputs_b(const data_b_t b_buf[8][256],
                          data_b_t in_b[8], uint16_t t, uint16_t m)
{
#pragma HLS INLINE
...
static void load_inputs_sa(SA *sa, data_a_t in_a[8], data_b_t in_b[8])
{
#pragma HLS INLINE
...
# 100 "/home/ulisses/Projects/ursa/exp/output-stationary-v2/sources/vanilla/src/core/shell.cpp"
static void load_tile_a(const a_word_t *a, uint32_t word_off, uint16_t wpr,
                        a_word_t a_buf[8][(256 / 8)])
{
    uint16_t r = 0, c = 0;
    const uint32_t n_words = (uint32_t)8 * wpr;
...
#pragma HLS LOOP_TRIPCOUNT min=36 max=144 avg=144
 b_word_t w = b[idx];
        VITIS_LOOP_127_1: for (uint16_t jj = 0; jj < 8; jj++) {
#pragma HLS UNROLL
...
# 146 "/home/ulisses/Projects/ursa/exp/output-stationary-v2/sources/vanilla/src/core/shell.cpp"
...
#pragma HLS INTERFACE mode=m_axi port=addr_a0 bundle=aw offset=slave num_read_outstanding=8 num_write_outstanding=8 max_read_burst_length=64 max_write_burst_length=16 depth=1024



#pragma HLS INTERFACE mode=m_axi port=addr_b0 bundle=bi offset=slave num_read_outstanding=8 num_write_outstanding=8 max_read_burst_length=64 max_write_burst_length=16 depth=2048
...
#pragma HLS ARRAY_PARTITION variable=sa complete dim=1
 ...
 sa_init(&sa);
    ...
    const uint16_t call_a = a0_p / 8;
    const uint16_t call_b = b0_q / 8;

    const uint16_t wpr = (m + 8 - 1) / 8;
    const uint32_t stride_a = (uint32_t)8 * wpr;
    const uint32_t stride_c = (uint32_t)8 * b0_q;
    const uint32_t qw = b0_q / 8;
...
#pragma HLS LOOP_TRIPCOUNT min=16 max=64 avg=16
 ...
 load_tile_b(addr_b0, j, qw, m, b_buf);
            ...
            STREAM_K: for (uint16_t t = 0; t < m + 2*(8 -1); t++) {
#pragma HLS PIPELINE II=1
