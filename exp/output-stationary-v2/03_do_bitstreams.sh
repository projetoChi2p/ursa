...
# UM: 25/09/26 - Group 2 is disabled for the v2 sweep. The mitigated block
# designs (bd_*_tmr*.tcl) were built around the v1 IP: 32-bit controllers and
# the old address map. They need the same rework as bd_bram.tcl before they
# can take the v2 IP.
