...
if [ ! -f ${SUMMARY} ]; then
    echo "build,variant,sa_size,acc_bits,layout,status,wns_ns,whs_ns,lut,lut_pct,ff,ff_pct,dsp,dsp_pct,bram,bram_pct,essential_bits,total_cram_bits" > ${SUMMARY}
fi
...
for layout in ${LAYOUTS[*]}; do
    ...
    if [ ${RC} -eq 0 ]; then
        ...
        echo "${build_name},${VARIANT},${sz},${acc},${layout},ok,${WNS},${WHS},${LUT},${LUT_PCT},${FF},${FF_PCT},${DSP},${DSP_PCT},${BRAM},${BRAM_PCT},${EB},${EBTOT}" >> ${SUMMARY}
