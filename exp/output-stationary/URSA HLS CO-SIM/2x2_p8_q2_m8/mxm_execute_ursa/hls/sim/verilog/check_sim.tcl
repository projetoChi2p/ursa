...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.mxm_execute_ursa.autotvin_aw.dat"
         "c.mxm_execute_ursa.autotvin_bi.dat"
         "c.mxm_execute_ursa.autotvin_addr_a0.dat"
         "c.mxm_execute_ursa.autotvin_a0_p.dat"
         "c.mxm_execute_ursa.autotvin_addr_b0.dat"
         "c.mxm_execute_ursa.autotvin_b0_q.dat"
         "c.mxm_execute_ursa.autotvin_addr_c0.dat"
         "c.mxm_execute_ursa.autotvin_m.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.mxm_execute_ursa.autotvout_ca.dat"
         "rtl.mxm_execute_ursa.autotvout_ap_return.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
