...
if {[file isfile mxm_execute_ursa.autotvin.dat]} {
	file delete -force mxm_execute_ursa.autotvin.dat
}

if {[file isfile mxm_execute_ursa.autotvout.dat]} {
	file delete -force mxm_execute_ursa.autotvout.dat
}
