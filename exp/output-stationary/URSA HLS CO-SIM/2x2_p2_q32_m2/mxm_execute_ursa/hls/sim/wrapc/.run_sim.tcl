...
set ::env(LD_LIBRARY_PATH) /opt/Xilinx/Vitis_HLS/2023.2/lib/lnx64.o/Ubuntu:$::env(LD_LIBRARY_PATH)
...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "mxm_execute_ursa.autotvin.dat"
	set constFileTvOut       "mxm_execute_ursa.autotvout.dat"
	set constFileHdlTvIn     "mxm_execute_ursa.autohdltvin.dat"
	set constFileHdlTvOut    "mxm_execute_ursa.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
