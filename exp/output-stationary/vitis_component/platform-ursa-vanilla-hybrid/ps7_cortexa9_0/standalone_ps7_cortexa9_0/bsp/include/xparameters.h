...
#define XPAR_XMXM_EXECUTE_URSA_NUM_INSTANCES 1

/* Definitions for peripheral MXM_EXECUTE_URSA_0 */
#define XPAR_MXM_EXECUTE_URSA_0_COMPATIBLE xlnx,mxm-execute-ursa-1.0
#define XPAR_MXM_EXECUTE_URSA_0_BASEADDR 0x40000000
#define XPAR_MXM_EXECUTE_URSA_0_HIGHADDR 0x40001fff
#define XPAR_MXM_EXECUTE_URSA_0_BASEADDR_1 0x40010000

/* Canonical definitions for peripheral MXM_EXECUTE_URSA_0 */
#define XPAR_XMXM_EXECUTE_URSA_0_BASEADDR 0x40000000
#define XPAR_XMXM_EXECUTE_URSA_0_HIGHADDR 0x40001fff
#define XPAR_XMXM_EXECUTE_URSA_0_COMPATIBLE xlnx,mxm-execute-ursa-1.0
