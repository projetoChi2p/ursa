# 1 "/home/ulisses/Projects/ursa/exp/output-stationary/vitis_component/inp_data/hls_src/core/sa.cpp"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 376 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "/home/ulisses/Projects/ursa/exp/output-stationary/vitis_component/inp_data/hls_src/core/sa.cpp" 2
...
void sa_reset(SA *sa);
# 2 "/home/ulisses/Projects/ursa/exp/output-stationary/vitis_component/inp_data/hls_src/core/sa.cpp" 2
...
#pragma HLS PIPELINE II=1
 ...
 VITIS_LOOP_16_1: for(i=0;i<8;i++){
#pragma HLS UNROLL
 VITIS_LOOP_18_2: for(j=0;j<8;j++){
#pragma HLS UNROLL
 pe_init(&sa->pe[i][j]);
      }
   }
...
#pragma HLS PIPELINE II=1
 ...
 VITIS_LOOP_28_1: for(uint16_t i=0;i<8;i++){
#pragma HLS UNROLL
 VITIS_LOOP_30_2: for(uint16_t j=0;j<8;j++){
#pragma HLS UNROLL
 pe_reset(&sa->pe[i][j]);
        }
    }
...
#pragma HLS UNROLL
 sa->pe[i][0].li = sa->in_mtx_a_li[i];
   ...
   VITIS_LOOP_58_2: for(j=1;j<8;j++) {
#pragma HLS UNROLL
 VITIS_LOOP_60_3: for(i=0;i<8;i++) {
#pragma HLS UNROLL
 sa->pe[i][j].li = sa->pe[i][j-1].ri;
   ...
   VITIS_LOOP_67_4: for(i=1;i<8;i++) {
#pragma HLS UNROLL
 VITIS_LOOP_69_5: for(j=0;j<8;j++) {
#pragma HLS UNROLL
 sa->pe[i][j].tw = sa->pe[i-1][j].bw;
   ...
   VITIS_LOOP_76_6: for(i=0;i<8;i++) {
#pragma HLS UNROLL
 VITIS_LOOP_78_7: for(j=0;j<8;j++) {
#pragma HLS UNROLL
...
#pragma HLS PIPELINE II=1
 ...
 VITIS_LOOP_88_1: for(uint16_t i=0;i<8;i++){
#pragma HLS UNROLL
 VITIS_LOOP_90_2: for(uint16_t j=0;j<8;j++){
#pragma HLS UNROLL
