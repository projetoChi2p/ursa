set SynModuleInfo {
  {SRCNAME mxm_execute_ursa_Pipeline_STREAM_K MODELNAME mxm_execute_ursa_Pipeline_STREAM_K RTLNAME mxm_execute_ursa_mxm_execute_ursa_Pipeline_STREAM_K
    SUBMODULES {
      {MODELNAME mxm_execute_ursa_mul_16ns_5ns_20_2_1 RTLNAME mxm_execute_ursa_mul_16ns_5ns_20_2_1 BINDTYPE op TYPE mul IMPL auto LATENCY 1 ALLOW_PRAGMA 1}
      {MODELNAME mxm_execute_ursa_mul_17s_16ns_32_2_1 RTLNAME mxm_execute_ursa_mul_17s_16ns_32_2_1 BINDTYPE op TYPE mul IMPL auto LATENCY 1 ALLOW_PRAGMA 1}
  ...
  {SRCNAME sa_store MODELNAME sa_store RTLNAME mxm_execute_ursa_sa_store
    SUBMODULES {
      {MODELNAME mxm_execute_ursa_mac_muladd_16ns_6ns_32s_32_4_1 RTLNAME mxm_execute_ursa_mac_muladd_16ns_6ns_32s_32_4_1 BINDTYPE op TYPE all IMPL dsp_slice LATENCY 3 ALLOW_PRAGMA 1}
    }
  }
  ...
  {SRCNAME mxm_execute_ursa MODELNAME mxm_execute_ursa RTLNAME mxm_execute_ursa IS_TOP 1
    SUBMODULES {
      {MODELNAME mxm_execute_ursa_mul_12ns_12ns_24_2_1 RTLNAME mxm_execute_ursa_mul_12ns_12ns_24_2_1 BINDTYPE op TYPE mul IMPL auto LATENCY 1 ALLOW_PRAGMA 1}
