...
set solution_dir "/home/ulisses/Projects/ursa/exp/vitis/hls_ursa_8x8/mxm_execute_ursa/hls"
set solution_json_file [file join $solution_dir [file tail $solution_dir]_data.json]
set debug_dir "/home/ulisses/Projects/ursa/exp/vitis/hls_ursa_8x8/mxm_execute_ursa/hls/.debug"
set xo_hls_files_dir ""
set hdl_module_list {mxm_execute_ursa_mul_17s_16ns_32_1_1
...
set Interfaces {
    ...
    s_axi_control {
        ...
        addr_bits "6"
        port_width "AWADDR 6 WDATA 32 WSTRB 4 ARADDR 6 RDATA 32"
        registers {{0x10 addr_a0 W 0x0 "Data signal of addr_a0" {{0 32 addr_a0 W 0 "Bit 31 to 0 of addr_a0"}}} {0x18 addr_b0 W 0x0 "Data signal of addr_b0" {{0 32 addr_b0 W 0 "Bit 31 to 0 of addr_b0"}}} {0x20 addr_c0 W 0x0 "Data signal of addr_c0" {{0 32 addr_c0 W 0 "Bit 31 to 0 of addr_c0"}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
    ...
    m_axi_aw {
        ...
        handshake ""
        busParams "NUM_READ_OUTSTANDING 8 NUM_WRITE_OUTSTANDING 8 MAX_READ_BURST_LENGTH 16 MAX_WRITE_BURST_LENGTH 16 MAX_BURST_LENGTH 256 PROTOCOL AXI4 READ_WRITE_MODE READ_ONLY HAS_BURST 0 SUPPORTS_NARROW_BURST 0"
        Object "aw"
        ctype {
            AWLEN {
                Type "integer unsigned"
    ...
    m_axi_ca {
        ...
        preferredUsageValue "MEMORY"
        handshake ""
        busParams "NUM_READ_OUTSTANDING 8 NUM_WRITE_OUTSTANDING 8 MAX_READ_BURST_LENGTH 16 MAX_WRITE_BURST_LENGTH 16 MAX_BURST_LENGTH 256 PROTOCOL AXI4 READ_WRITE_MODE WRITE_ONLY HAS_BURST 0 SUPPORTS_NARROW_BURST 0"
        Object "ca"
        ctype {
            AWLEN {
                Type "integer unsigned"
