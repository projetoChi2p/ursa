...
void XMxm_execute_ursa_Set_addr_a0(XMxm_execute_ursa *InstancePtr, u64 Data) {
    Xil_AssertVoid(InstancePtr != NULL);
    Xil_AssertVoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    XMxm_execute_ursa_WriteReg(InstancePtr->Control_BaseAddress, XMXM_EXECUTE_URSA_CONTROL_ADDR_ADDR_A0_DATA, (u32)(Data));
    XMxm_execute_ursa_WriteReg(InstancePtr->Control_BaseAddress, XMXM_EXECUTE_URSA_CONTROL_ADDR_ADDR_A0_DATA + 4, (u32)(Data >> 32));
}

u64 XMxm_execute_ursa_Get_addr_a0(XMxm_execute_ursa *InstancePtr) {
    u64 Data;
    ...
    Data += (u64)XMxm_execute_ursa_ReadReg(InstancePtr->Control_BaseAddress, XMXM_EXECUTE_URSA_CONTROL_ADDR_ADDR_A0_DATA + 4) << 32;
    return Data;
}

void XMxm_execute_ursa_Set_addr_b0(XMxm_execute_ursa *InstancePtr, u64 Data) {
    Xil_AssertVoid(InstancePtr != NULL);
    Xil_AssertVoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    XMxm_execute_ursa_WriteReg(InstancePtr->Control_BaseAddress, XMXM_EXECUTE_URSA_CONTROL_ADDR_ADDR_B0_DATA, (u32)(Data));
    XMxm_execute_ursa_WriteReg(InstancePtr->Control_BaseAddress, XMXM_EXECUTE_URSA_CONTROL_ADDR_ADDR_B0_DATA + 4, (u32)(Data >> 32));
}

u64 XMxm_execute_ursa_Get_addr_b0(XMxm_execute_ursa *InstancePtr) {
    u64 Data;
    ...
    Data += (u64)XMxm_execute_ursa_ReadReg(InstancePtr->Control_BaseAddress, XMXM_EXECUTE_URSA_CONTROL_ADDR_ADDR_B0_DATA + 4) << 32;
    return Data;
}

void XMxm_execute_ursa_Set_addr_c0(XMxm_execute_ursa *InstancePtr, u64 Data) {
    Xil_AssertVoid(InstancePtr != NULL);
    Xil_AssertVoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    XMxm_execute_ursa_WriteReg(InstancePtr->Control_BaseAddress, XMXM_EXECUTE_URSA_CONTROL_ADDR_ADDR_C0_DATA, (u32)(Data));
    XMxm_execute_ursa_WriteReg(InstancePtr->Control_BaseAddress, XMXM_EXECUTE_URSA_CONTROL_ADDR_ADDR_C0_DATA + 4, (u32)(Data >> 32));
}

u64 XMxm_execute_ursa_Get_addr_c0(XMxm_execute_ursa *InstancePtr) {
    u64 Data;
    ...
    Data += (u64)XMxm_execute_ursa_ReadReg(InstancePtr->Control_BaseAddress, XMXM_EXECUTE_URSA_CONTROL_ADDR_ADDR_C0_DATA + 4) << 32;
    return Data;
}
