# 1 "/home/fi/Documents/GitHub/ursa/exp/ursa_ws/src/core/sa.cpp"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 376 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "/home/fi/Documents/GitHub/ursa/exp/ursa_ws/src/core/sa.cpp" 2
# 1 "/home/fi/Documents/GitHub/ursa/exp/ursa_ws/src/core/sa.h" 1



# 1 "/home/fi/Documents/GitHub/ursa/exp/ursa_ws/src/core/pe.h" 1



# 1 "/home/fi/Documents/GitHub/ursa/exp/ursa_ws/src/core/../settings.h" 1
...
# 5 "/home/fi/Documents/GitHub/ursa/exp/ursa_ws/src/core/../settings.h" 2
...
# 6 "/home/fi/Documents/GitHub/ursa/exp/ursa_ws/src/core/../settings.h" 2
...
# 8 "/home/fi/Documents/GitHub/ursa/exp/ursa_ws/src/core/../settings.h" 2
...
# 15 "/home/fi/Documents/GitHub/ursa/exp/ursa_ws/src/core/../settings.h" 2
# 40 "/home/fi/Documents/GitHub/ursa/exp/ursa_ws/src/core/../settings.h"
...
# 41 "/home/fi/Documents/GitHub/ursa/exp/ursa_ws/src/core/../settings.h" 2

    typedef ap_int <8> data_a_t;
    typedef ap_uint <8> data_b_t;
    typedef ap_int <32> data_c_t;
    typedef ap_int <20> macc_t;
# 54 "/home/fi/Documents/GitHub/ursa/exp/ursa_ws/src/core/../settings.h"
typedef data_c_t lr_t;
typedef data_b_t tb_t;
typedef data_a_t fixed_t;
...
# 136 "/home/fi/Documents/GitHub/ursa/exp/ursa_ws/src/core/../settings.h"
...
# 5 "/home/fi/Documents/GitHub/ursa/exp/ursa_ws/src/core/pe.h" 2
...
# 5 "/home/fi/Documents/GitHub/ursa/exp/ursa_ws/src/core/sa.h" 2
...
#pragma HLS PIPELINE II=1
 uint16_t i, j;
   ...
   VITIS_LOOP_50_1: for(j=0; j<8; j++){
#pragma HLS UNROLL
 sa->pe[0][j].t_in = sa->in_mtx_t[j];
   }


   VITIS_LOOP_56_2: for(i=1; i<8; i++) {
#pragma HLS UNROLL
 VITIS_LOOP_58_3: for(j=0; j<8; j++) {
#pragma HLS UNROLL
 sa->pe[i][j].t_in = sa->pe[i-1][j].b_out;
   ...
   VITIS_LOOP_65_4: for(i=0; i<8; i++) {
#pragma HLS UNROLL
 VITIS_LOOP_67_5: for(j=0; j<8; j++) {
#pragma HLS UNROLL
...
#pragma HLS UNROLL
 sa->pe[i][0].l_in = sa->in_mtx_l[i];
   ...
   VITIS_LOOP_87_2: for(j=1;j<8;j++) {
#pragma HLS UNROLL
 VITIS_LOOP_89_3: for(i=0;i<8;i++) {
#pragma HLS UNROLL
 sa->pe[i][j].l_in = sa->pe[i][j-1].r_out;
   ...
   VITIS_LOOP_96_4: for(i=1;i<8;i++) {
#pragma HLS UNROLL
 VITIS_LOOP_98_5: for(j=0;j<8;j++) {
#pragma HLS UNROLL
 sa->pe[i][j].t_in = sa->pe[i-1][j].b_out;
      }
   }
   ...
   VITIS_LOOP_105_6: for(i=0;i<8;i++) {
#pragma HLS UNROLL
 VITIS_LOOP_107_7: for(j=0;j<8;j++) {
#pragma HLS UNROLL
